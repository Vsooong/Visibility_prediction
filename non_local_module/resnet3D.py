...
from non_local_module.non_local_em_gaussian import NONLocalBlock3D
...
class ResNet3D(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, padding=(0, 1, 1), d_padding=(2, 0, 0), non_local=False):
        ...
        if non_local:
            layers.append(NONLocalBlock3D(in_channels=1024))
            layers.append(block(self.inplanes, planes))
...
if __name__ == '__main__':
    ...
    img = Variable(torch.randn(2, 3, 10, 360, 640))
